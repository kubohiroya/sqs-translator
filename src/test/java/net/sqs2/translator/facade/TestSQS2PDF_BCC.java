...
public class TestSQS2PDF_BCC extends AbstractTestSQS2PDF
{
    
    @Test
    public void testSQS2PDF_BCC() throws Exception
    {
        final SQS2PDF sqs2pdf = getSQS2PDF("BCC1.sqs.xml", Locale.ENGLISH);
